...
var _gsap = {
  ...
  quickTo: function quickTo(target, property, vars) {
    var _setDefaults222;
    var tween = gsap$2.to(target, _setDefaults$1((_setDefaults222 = {}, _setDefaults222[property] = "+=0.1", _setDefaults222.paused = true, _setDefaults222.stagger = 0, _setDefaults222), vars || {})), func = function func2(value, start, startIsRelative) {
...
}, _callback = function _callback22(self, func) {
  if (self.enabled) {
...
export { ScrollTrigger as S, gsapWithCSS as g };
